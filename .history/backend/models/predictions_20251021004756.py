...
DAILY_MODEL_DIR = os.path.join(BACKEND_DIR, "model_store/lstm_daily")
WEEKLY_MODEL_DIR = os.path.join(BACKEND_DIR, "model_store/lstm_weekly")
...
try:
    ...
    print(f"🔴 ERROR: Could not load 'model_store/lstm_weekly/weekly_features.json'. Error: {e}")
    WEEKLY_FEATURES = []
