          ...
          <Tabs defaultValue="day-night" className="space-y-8">
            ...
            <TabsContent value="correlation" className="space-y-6 animate-fade-in">
              <Card className="p-8 shadow-medium border-2">
                 ...
                 {/* Method Selection */}
                 <div className="mb-6 max-w-lg"> {/* Increased max-w slightly */}
                    ...
                    <div className="mt-3 text-xs text-muted-foreground space-y-1">
                        <p>• **Pearson:** Measures linear relationships (how well data fits a straight line).</p>
                        <p>• **Spearman:** Measures monotonic relationships (how well data follows a trend, even if not linear).</p>
                        <p>• **Kendall:** Measures ordinal relationships (similarity of orderings between variables).</p>
                        <p>*(Spearman is often a good general choice)*</p>
                    </div>
                    {/* --- END ADDED DIV --- */}
                 </div>
                 ...
                 {/* Heatmap container */}
                 {/* ... (rest of heatmap and insights code) ... */}
              </Card>
            </TabsContent>
